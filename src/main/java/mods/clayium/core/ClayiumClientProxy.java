...
public class ClayiumClientProxy implements IClayiumProxy {
    ...
    public void preInit(FMLPreInitializationEvent event) {
        ...
        RenderingRegistry.registerEntityRenderingHandler(EntityClayBall.class,
                manager -> new RenderSnowball<>(manager, Items.CLAY_BALL, Minecraft.getMinecraft().getRenderItem()));
        RenderingRegistry.registerEntityRenderingHandler(EntityTeleportBall.class,
                manager -> new RenderSnowball<>(manager, Items.ENDER_PEARL, Minecraft.getMinecraft().getRenderItem()));
    }
    ...
    public void registerColors() {
        ...
        SiliconeColor.registerColorHandler(Minecraft.getMinecraft().getItemColors(),
                Minecraft.getMinecraft().getBlockColors());
    }

    public void registerTileEntity() {
        GameRegistry.registerTileEntity(TileEntityClayWorkTable.class,
                new ResourceLocation(ClayiumCore.ModId, "clay_work_table"));
        GameRegistry.registerTileEntity(TileEntityClayCraftingTable.class,
                new ResourceLocation(ClayiumCore.ModId, "clay_crafting_table"));

        ClientRegistry.registerTileEntity(TileEntityClayBuffer.class, "clayium:buffer", TESRClayContainer.instance);
        ClientRegistry.registerTileEntity(TileEntityClayiumMachine.class, "clayium:machine",
                TESRClayContainer.instance);
        ClientRegistry.registerTileEntity(TileEntityCobblestoneGenerator.class, "clayium:cobblestone_generator",
                TESRClayContainer.instance);
        ClientRegistry.registerTileEntity(TileEntityClayAssembler.class, "clayium:assembler",
                TESRClayContainer.instance);
        ClientRegistry.registerTileEntity(TileEntityMultitrackBuffer.class, "clayium:multitrack_buffer",
                TESRClayContainer.instance);
        ClientRegistry.registerTileEntity(TileEntitySaltExtractor.class, "clayium:salt_extractor",
                TESRClayContainer.instance);
        ClientRegistry.registerTileEntity(TileEntityClayEnergyLaser.class, "clayium:laser",
                new TileEntitySpecialRenderer<TileEntityClayEnergyLaser>() {

                    @Override
                    public void render(TileEntityClayEnergyLaser te, double x, double y, double z, float partialTicks,
                                       int destroyStage, float alpha) {
                        TESRClayContainer.render(te, x, y, z, partialTicks, destroyStage, alpha,
        ...
        ClientRegistry.registerTileEntity(TileEntityLaserReflector.class, "clayium:laser_reflector",
                new TESRLaserReflector());
        // Item.getItemFromBlock(ClayiumMachines.laserReflector).setTileEntityItemStackRenderer(new
        // TEISRLaserReflector());
        ClientRegistry.registerTileEntity(TileEntityClayChemicalReactor.class, "clayium:chemical_reactor",
                TESRClayContainer.instance);
        ClientRegistry.registerTileEntity(TileEntityAutoClayCondenser.class, "clayium:auto_clay_condenser",
                TESRClayContainer.instance);
        ClientRegistry.registerTileEntity(TileEntitySolarClayFabricator.class, "clayium:solar_clay_fabricator",
                TESRClayContainer.instance);
        ClientRegistry.registerTileEntity(TileEntityClayFabricator.class, "clayium:clay_fabricator",
                TESRClayContainer.instance);
        ClientRegistry.registerTileEntity(TileEntityChemicalMetalSeparator.class, "clayium:chemical_metal_separator",
                TESRClayContainer.instance);
        ClientRegistry.registerTileEntity(TileEntityClayInterface.class, "clayium:clay_interface",
                new TileEntitySpecialRenderer<TileEntityClayInterface>() {
                    ...
                    @Override
                    public void render(TileEntityClayInterface te, double x, double y, double z, float partialTicks,
                                       int destroyStage, float alpha) {
                        TESRClayContainer.render(te, x, y, z, partialTicks, destroyStage, alpha,
                                this.rendererDispatcher);
        ...
        ClientRegistry.registerTileEntity(TileEntityClayBlastFurnace.class, "clayium:blast_furnace",
                TESRClayContainer.instance);
        ClientRegistry.registerTileEntity(TileEntityRedstoneInterface.class, "clayium:redstone_interface",
                TESRInterface.instance);
        ClientRegistry.registerTileEntity(TileEntityClayLaserInterface.class, "clayium:laser_interface",
                TESRInterface.instance);

        ClientRegistry.registerTileEntity(TileEntityCreativeEnergySource.class, "clayium:creative_energy",
                TESRClayContainer.instance);
        GameRegistry.registerTileEntity(TileEntityQuartzCrucible.class,
                new ResourceLocation(ClayiumCore.ModId, "quartz_crucible"));
        ClientRegistry.registerTileEntity(TileEntityClayDistributor.class, "clayium:distributor",
                TESRClayContainer.instance);
        ClientRegistry.registerTileEntity(TileEntityAutoCrafter.class, "clayium:auto_crafter",
                TESRClayContainer.instance);
        // GameRegistry.registerTileEntity(TileEntityAutoCrafter.class, new ResourceLocation(ClayiumCore.ModId,
        // "auto_crafter"));
        ClientRegistry.registerTileEntity(TileEntityClayReactor.class, "clayium:reactor", TESRClayContainer.instance);

        ClientRegistry.registerTileEntity(TileEntityCACondenser.class, "clayium:ca_condenser",
                TESRClayContainer.instance);
        ClientRegistry.registerTileEntity(TileEntityCAInjector.class, "clayium:ca_injector",
                TESRClayContainer.instance);

        ClientRegistry.registerTileEntity(TileEntityClayCentrifuge.class, "clayium:centrifuge",
                TESRClayContainer.instance);
        ClientRegistry.registerTileEntity(TileEntityStorageContainer.class, "clayium:storage_container",
                TESRClayContainer.instance);
        ClientRegistry.registerTileEntity(TileEntityVacuumContainer.class, "clayium:vacuum_container",
                TESRClayContainer.instance);
    }
    ...
    public void overclockPlayer(int delay) {
        int i;
        try {
            i = ObfuscationReflectionHelper.getPrivateValue(PlayerControllerMP.class,
                    Minecraft.getMinecraft().playerController, "field_78781_i");
            // i = this.blockHitDelay.getInt(Minecraft.getMinecraft().playerController);
            if (i >= delay) {
                ObfuscationReflectionHelper.setPrivateValue(PlayerControllerMP.class,
                        Minecraft.getMinecraft().playerController, delay, "field_78781_i");
        ...
        try {
            i = ObfuscationReflectionHelper.getPrivateValue(Minecraft.class, Minecraft.getMinecraft(),
                    "field_71467_ac");
            // i = this.rightClickDelayTimer.getInt(Minecraft.getMinecraft());
            if (i >= delay + 1) {
                ObfuscationReflectionHelper.setPrivateValue(Minecraft.class, Minecraft.getMinecraft(), delay + 1,
                        "field_71467_ac");
