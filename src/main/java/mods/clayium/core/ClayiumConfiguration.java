...
public class ClayiumConfiguration {
    ...
    public void loadConfig(FMLPreInitializationEvent event) {
        ...
        cfgEnableInjectorRecipeOfInterface = cfg.getBoolean("EnableInjectorRecipeOfInterface", "mode", false,
                "This recipe makes it much easier to construct multi-block machines.");
        ...
        cfgFluidCapsuleCreativeTabMode = cfg.getInt("FluidCapsuleCreativeTabMode", "misc", 1, 0, 2,
                "This setting is also valid for NEI.  0: Disable  1: 1000mB only  2: Display All");
        cfgEnableAlternativeTileEntityName = cfg.getBoolean("EnableAlternativeTileEntityName", "misc", true,
                "Disable this if a tile entity id of this mod conflicts with one of other mod.");
        ...
        cfgEnableRFGenerator = cfg.getBoolean("EnableRFGenerator", "misc", false,
                "This setting enables assembler recipes for RF Converters.");
        cfgRFGenerator = new String[] { "BasicRFGenerator;rfgenerator:4:0.001:10:10:10000:1",
                "AdvancedRFGenerator;rfgenerator:5:0.01:30:30:30000:1",
                "PrecisionRFGenerator;rfgenerator:6:0.1:90:90:90000:1",
                "ClaySteelRFGenerator;rfgenerator:7:1:270:270:270000:1",
                "ClayiumRFGenerator;rfgenerator:8:10:810:810:810000:1",
                ...
                "OECRFGenerator;rfgenerator:12:100000:65610:65610:65610000:1",
                "OPARFGenerator;rfgenerator:13:1000000:196830:196830:196830000:1" };
        cfgRFGenerator = cfg.getStringList("RFGenerator", "misc", cfgRFGenerator,
