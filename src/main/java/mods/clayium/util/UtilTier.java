...
public class UtilTier {
    ...
    public static class TierManager
        ...
        public static TierManager getMachineTierManager(String configName) {
            ...
            res.put("multCraftTime", new TieredNumericStatus<Float>(1.0F, 0.0F, 1.0E9F));
            res.put("multConsumingEnergy", new TieredNumericStatus<Float>(1.0F, 0.0F, 1.0E9F));
            return res;
        }

        public static TierManager getTransportTierManager(String configName) {
            TierManager res = new TierManager(configName);
            res.put("autoInsertInterval", new TieredNumericStatus<Integer>(20, 1, 999));
            res.put("autoExtractInterval", new TieredNumericStatus<Integer>(20, 1, 999));
            res.put("maxAutoInsertDefault", new TieredNumericStatus<Integer>(8, 1, 9999));
            res.put("maxAutoExtractDefault", new TieredNumericStatus<Integer>(8, 1, 9999));
            return res;
        }
        ...
        public void loadAllConfig(Configuration cfg) {
            for (Entry<String, TieredStatus> entry : entrySet())
