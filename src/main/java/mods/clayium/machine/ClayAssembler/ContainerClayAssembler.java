...
public class ContainerClayAssembler extends ContainerIMachine {
    ...
    public void setMachineInventorySlots(InventoryPlayer player) {
        this.addMachineSlotToContainer(new SlotWithTexture(this.tileEntity, Machine2To1.MATERIAL_1, 32, 35, RectangleTexture.SmallSlotImport1Texture));

        this.addMachineSlotToContainer(new SlotWithTexture(this.tileEntity, Machine2To1.MATERIAL_2, 50, 35, RectangleTexture.SmallSlotImport2Texture));

        this.addMachineSlotToContainer(new SlotWithTexture(this.tileEntity, Machine2To1.PRODUCT, 116, 35, RectangleTexture.LargeSlotTexture) {
            @Override
