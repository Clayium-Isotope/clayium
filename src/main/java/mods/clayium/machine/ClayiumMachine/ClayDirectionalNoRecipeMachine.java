...
public class ClayDirectionalNoRecipeMachine extends ClayDirectionalContainer {
    ...
    public ClayDirectionalNoRecipeMachine(Class<? extends TileEntityGeneric> teClass, EnumMachineKind kind,
    ...
    public ClayDirectionalNoRecipeMachine(Class<? extends TileEntityGeneric> teClass, EnumMachineKind kind, int guiId,
                                          TierPrefix tier) {
