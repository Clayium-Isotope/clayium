...
/**
 * Copied from: <a href=
 * "https://github.com/MinecraftForge/MinecraftForge/blob/1.12.2/src/minecraft/client/gui/GuiCrafting.java">GuiCrafting</a>
 */
...
public class GuiClayCraftingTable extends GuiTemp implements IRecipeShownListener {
    ...
    public void initGui() {
        ...
        this.recipeBookGui.func_194303_a(this.width, this.height, this.mc, this.widthTooNarrow,
                ((ContainerClayCraftingTable) this.inventorySlots).craftMatrix);
        this.guiLeft = this.recipeBookGui.updateScreenPosition(this.widthTooNarrow, this.width, this.xSize);
        this.recipeButton = new GuiButtonImage(10, this.guiLeft + 5, this.guiTop + 37, 20, 18, 0, 168, 19,
    ...
    protected boolean hasClickedOutside(int p_193983_1_, int p_193983_2_, int p_193983_3_, int p_193983_4_) {
        boolean flag = p_193983_1_ < p_193983_3_ || p_193983_2_ < p_193983_4_ ||
                p_193983_1_ >= p_193983_3_ + this.xSize || p_193983_2_ >= p_193983_4_ + this.ySize;
