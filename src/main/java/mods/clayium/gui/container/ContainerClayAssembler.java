...
public class ContainerClayAssembler extends ContainerClayMachines {
    ...
    public void setMachineInventorySlots(InventoryPlayer player) {
        ...
        addMachineSlotToContainer((Slot) new SlotResultWithTexture(this.tile, 2, 116, 35, RectangleTexture.LargeSlotTexture));
    }
}
