...
public abstract class FDWithHandler<S, T>
    ...
    public static interface IFunctionalIterable<S, T> {
        FDWithHandler.IFunctionalIterator<S, T> iterator(T param1T);
    }
    ...
    public static class FunctionalList<S, T> implements IFunctionalIterable<S, T> {
        ...
        public FDWithHandler.IFunctionalIterator<S, T> iterator(T param) {
            return new FDWithHandler.FunctionalIterator<S, T>(this.iterable.iterator());
        }
    }
