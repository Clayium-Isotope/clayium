...
public class TileClayReactor extends TileMultiblockMachines implements IClayLaserMachine {
            ...
            for (int xx = -1; xx <= 1; xx++) {
                for (int zz = 0; zz <= 2; zz++) {
                    if (xx != 0 || yy != 0 || zz != 0) {
                        ...
                        } else if (te != null && te instanceof TileClayLaserInterface) {
                            flag = false;
                        }
                    }
                }
    ...
    public boolean canProceedCraftWhenConstructed() {
        if (this.containerItemStacks[4] != null || this.containerItemStacks[5] != null) {
            ...
            return getCraftPermutation(arrayOfItemStack) != null;
        }
        ItemStack[] itemstacks = {this.containerItemStacks[0], this.containerItemStacks[1]};
        return getCraftPermutation(itemstacks) != null;
    }
